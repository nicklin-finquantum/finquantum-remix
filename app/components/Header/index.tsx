...
import MortgageAnalysisButton from "./MortgageAnalysis";
...
const Header = (props: {
  ...
  return (
    <header className="bg-transparent sticky top-0 z-999 flex w-full drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none">
      <Box className="bg-white flex flex-grow items-center justify-between ml-1 p-4 shadow-2 md:px-6 2xl:px-11">
